# Generated by Django 2.0 on 2017-12-04 14:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Project.Book')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='Project.Genre'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
